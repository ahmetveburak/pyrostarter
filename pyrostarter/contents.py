phrases = {
    ...
    class BOT_NAME(Client, Message):
        def __init__(self):
            ...
            super().__init__(session_name=name,config_file=f"{moduleName}/{name}.ini",workers=8,plugins=dict(root=f"{moduleName}/plugins"),)
    ...
    async def ping(_, message: Message):
        ...
        my_buttons = {"Button1": "Button1","Button2": "Button2","Button3": "Button3", "Button4": "Button4",    "Button5": "Button5",}
    ...
    async def buttons(client: Client, message: Message):    
        me = await client.get_me()
            ...
            if me.is_bot:        
                await message.reply_text(text="These are test buttons with callback",reply_markup=buttonator.button_maker(buttons=my_buttons, size=2),)
